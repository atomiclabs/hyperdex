		...
		return (
			<div>
				<Modal
					...
					width="500px"
				>
					<p>HyperDEX is a decentralised exchange. It has a P2P order book and trades are made via <ExternalLink url="https://en.bitcoin.it/wiki/Atomic_cross-chain_trading">cross-chain atomic swaps</ExternalLink>. This means it works slightly differently than a centralized exchange.</p>
